...
## UTM application icon

`icon.png` is a 256×256 PNG version of the application icon from the [UTM project](https://github.com/utmapp/UTM), distributed under the [Apache License, Version 2.0](https://github.com/utmapp/UTM/blob/main/LICENSE). A copy of that licence is included in [LICENSE-UTM](LICENSE-UTM).
